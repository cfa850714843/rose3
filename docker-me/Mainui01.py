...
from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QHBoxLayout, QLabel, QSpacerItem, QSizePolicy, QPushButton, QTextEdit
...
class TitleBar(QWidget):
    ...
    def setHeight(self, height=40, buttonLevel=32):
        ...
        self.buttonMaximum.setMinimumSize(buttonLevel + 2, buttonLevel)
        self.buttonMaximum.setMaximumSize(buttonLevel + 2, buttonLevel)
        self.buttonClose.setMinimumSize(buttonLevel + 2, buttonLevel)
        self.buttonClose.setMaximumSize(buttonLevel + 2, buttonLevel)
...
if __name__ == '__main__':
    ...
    qIcon = QIcon('../logo/docker-logo-white.svg')
    mainWnd.setWindowIcon(qIcon)
    mainWnd.setIconSize(QSize(300, 200))
